    ...
    <section name='hoc builder' className='hoc_builder'>
        ...
        <p>
            ...
            <dl>
                ...
                <dd>
                    array : An array representing all splitted that will be merge into each component implementing this
                    current hoc.
                </dd>
                <dt>
                    <b>options</b>
        ...
        <p>
            In order to retrieve all the states and reduxers actions, the first hocs you registered into the{" "}
            <code>Store</code> must be filled with the whole list of reduxers, those will serve to fill the redux store.
        </p>
        ...
        <p>
            In component, the call the the thunk is made vi <code>{"this.props.call('thunkShortname', ...args)"}</code>
        </p>
        <p>
            If the options <code>{"{name: 'dispatch'}"}</code> for exemple is given then the call will be{" "}
            <code>{"this.props.dispatch('thunkShortname', ...args)"}</code>
        </p>
        ...
        <p>
            The <code>component</code> key, is a function returning a <Link to='/splitter'>Splitted class</Link>
        </p>
        <p>
            The <code>uses</code>, <code>state</code>, <code>actions</code>, are partials HOC arguments that will be passed
            in complement of main Component arguments.
        </p>

        <h3>Options</h3>

        <p>
            Actually the options takes the <code>name</code> key representing the property name to call the thunks actions
            and generic redux actions.
        </p>
        <p>
            The <code>bindAll</code> (boolean) binds every thing to every components
        </p>
        <p>
            The <code>pure</code> (string) is the hoc method to simply connect to the redux store
        </p>
